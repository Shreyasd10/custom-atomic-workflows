...
4. **Wait for all sub-agents to complete and synthesize findings:**
   ...
   - Verify all rpi/ paths are correct (task-specific files go in docs/research/)
   - Highlight patterns, connections, and architectural decisions
   - Answer the user's specific questions with concrete evidence

5. **Gather metadata for the research document:**
   - Filename: `docs/research/YYYY-MM-DD-research-DESCRIPTION.md`
     - First, check the task directory in your system prompt. If you do not see it, find the task directory: `ls docs/research/` | grep -i "eng-XXXX"`
     - If the directory doesn't exist, create: `docs/research/`
     - Format: `YYYY-MM-DD-research-DESCRIPTION.md` where NN is a zero-padded chronological index and DESCRIPTION is a 2-4 word kebab-case slug
     ...
     - Directory naming:
       - With ticket: `docs/research/`
       - Without ticket: `docs/research/`

6. **Generate research document:**
   - Use the metadata gathered in step 4
   - Read the research template:

   `Read(references/research_template.md)`

   - Write the document to `docs/research/YYYY-MM-DD-research-DESCRIPTION.md`
...
9. **Respond to the user according to the template**
   ...
   `Read(references/research_final_answer.md)`
...
- **Path handling**: Task-specific research goes in docs/research/
  - Use `docs/research/YYYY-MM-DD-research-DESCRIPTION.md` for task research

## Response

Remember, you must respond to the user according to the output template at `references/research_final_answer.md`
