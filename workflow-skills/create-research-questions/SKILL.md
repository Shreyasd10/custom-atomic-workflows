...
1. **Read all @-mentioned files immediately and FULLY**:
    ...
    - Ticket files (e.g., `docs/research/ticket.md`)
...
2. **Write the research questions** to `docs/research/YYYY-MM-DD-research-questions-DESCRIPTION.md`
   - First, check if a related task directory exists: `ls docs/research/` | grep -i "eng-XXXX"`
   - If the directory doesn't exist, create: `docs/research/`
   - Format: `YYYY-MM-DD-research-questions-DESCRIPTION.md` where NN is a zero-padded chronological index and DESCRIPTION is a 2-4 word kebab-case slug
